...
package io.github.ness_reverdy.lwjgl3;
...
/**
 * A helper object for GameWorld startup, featuring three utilities related to LWJGL3 on various operating systems.
 * <p>
...
public class StartupHelper {
	...
	private static final String CHILD_LOOP_ERR_MSG = "The current JVM process is a spawned child JVM process, but StartupHelper has attempted to spawn another child JVM process! This is a broken state, and should not normally happen! Your GameWorld may crash or not function properly!";
